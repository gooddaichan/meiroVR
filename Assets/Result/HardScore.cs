...
public class HardScore : MonoBehaviour
{
    ...
    void ReadScore()
    {
         ...
         */
        int i = 0;
        StreamReader sr = new StreamReader("Assets/Resources/HardRanking.txt");
        while (sr.Peek() > -1)
        {
            Debug.Log(i);
    ...
    {
        //score計算するよここから
        GetScoreTime = (int)(hard_timeScript.ScoreTime);




        if (hard_timeScript.ScoreTime == 0)
        {
            GetScoreStar = 0;
        }
        else
    ...
    void output(string[] Score2)
    {
        ...
        ranking = Score2[0] + "\n" + Score2[1] + "\n" + Score2[2] + "\n" + Score2[3] + "\n" + Score2[4] + "\n" +
            ...
            textYourTime_ex.text = hard_timeScript.ScoreTime.ToString("F0");//タイムのみ
    ...
    {
        StreamWriter sw = new StreamWriter("Assets/Resources/HardRanking.txt", false);
